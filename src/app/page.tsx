...
import { Zap, Users, Shield, ArrowRight, Package, Server, Star, CheckCircle } from "lucide-react"
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-orange-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 mb-8">
            Join thousands of developers using JudgeLib for safe code execution
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/docs">
